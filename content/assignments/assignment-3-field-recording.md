...
| --- | --- | --- | --- | --- | --- |
| **Ambience Beds (12 pts)** | Two to three minutes each of a large and a small space; both read unmistakably as their size | Both beds present at length; one space is less distinct | One bed short of the duration, or the two spaces sound alike | A bed missing | /12 |
