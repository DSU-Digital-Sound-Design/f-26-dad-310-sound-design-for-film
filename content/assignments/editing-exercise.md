...
Edit each of the following WAV files \(source-files.zip on D2L\) to meet the following specifications\:  
...
When finished, add comments to each track, and assign a unique track and region color. Save your session, zip it, and post it to D2L.  
